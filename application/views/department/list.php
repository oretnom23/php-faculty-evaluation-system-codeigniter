<div class="col-md-12 mt1 mb1">
    <div class="row">
        <a href="<?php echo base_url('department/manage') ?>" class="btn btn-info float-right"><i class="fa fa-plus"></i> New Department</a>
    </div>
</div>
    ...
    <div class="row">
        ...
        <div class="card col-md-12">
            <div class="card-body">
                ...
                <table class="table table-bordered table-striped" width="100%" id="department-field">
        ...
        success:function(resp){
            if(resp){
                ...
                Object.keys(resp).map(k=>{
                    ...
                    tr.append('<td><center><button type="button" class="btn btn-sm btn-outline-primary btn-rounded waves-effec edit_department" data-id="'+resp[k].id+'"><i class="fa fa-edit"></i></button><button type="button" class="btn btn-sm btn-outline-danger btn-rounded waves-effec remove_department" data-id="'+resp[k].id+'"><i class="fa fa-trash"></i></button></center></td>')
